    ...
    <div class="user-card" style="max-width: 800px; margin: 2rem auto;">
        ...
        <form method="post" action="process_createjob.asp">
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <select name="assignedTo" id="assignedTo" onchange="updateLoadCheck();" required style="width: 90%; padding: 12px; border-radius: 8px; border: 1px solid #d1d5db; font-size: 16px;">
                ...
                <!-- Load Check -->
                <div id="loadCheck" style="margin-top: 0.75rem; padding: 1rem; background: #fefce8; border-radius: 8px; font-weight: 600;">
                    Current Pending Jobs: <span id="pendingCount">0</span>
                </div>
